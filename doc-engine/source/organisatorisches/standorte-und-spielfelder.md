...
Uebersicht der aktiven TSV-Erbach-Standorte:
...
## Spielfeldbezeichnungen

Der Lageplan weist vier Spielfelder aus. Fuer die Trainingsdokumentation verwenden wir folgende Feld-IDs:
...
Das TSV Stadion kann je nach Trainingsziel in Teilbereiche aufgeteilt werden. Fuer die Dokumentation verwenden wir
folgende Bereichs-IDs:
...
- Begehung durch Daniel und Michael nach der letzten Besprechung.
- Positiver Platzbefund: Das Spielfeld hat eine sehr gute Groesse fuer
 C-Jugend Training und 11er-Spielbetrieb.
- Im Spielfeld stehen zwei feste Grossfeldtore.

### Tor Sued (hochgeklappt)

Die Einweisung zur Verwendung ist notwendig. Im Trainingsbetrieb sollte der feste Torbereich möglichst geschont werden.
...
Das Grossfeldtor Nord ist heruntergeklappt und daher bespielbar.
...
Jede neue Trainingseinheit sollte im Abschnitt Plan diese Angaben enthalten:
...
Detaillierte Informationen zur Trainingsausruestung, Wuensche, Bereitstellung und Alternativen finden Sie in:

[Trainingsausruestung C-Jugend](./trainingsausruestung-c-jugend.md)
...
Das Beispiel zeigt einen klaren, reproduzierbaren Aufbau:
