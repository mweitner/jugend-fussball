# 📋 Trainingsplan: Do 18.06 - D-Jugend (Jahrgang 2013/14) – Thema: Finten

## Eltern-Kurzblick

Heute steht mutiges 1-gegen-1 im Mittelpunkt. Die Kinder sollen Finten nicht nur
technisch ausfuehren, sondern in Spielsituationen erkennen, wann und wo sie sinnvoll sind.
...
- Finten im richtigen Moment mit Tempoveraenderung einsetzen.
- 1-gegen-1-Situationen mutig annehmen statt frueh abzuspielen.
- Kopf oben behalten und freie Raeume nach der Finte erkennen.
- Entscheidungen unter Gegnerdruck treffen.
...
#### ⚽ Spielform 2: Provokation des 1-gegen-1 (5-10 Minuten)
...
- **Rückblick (Interaktiv):**
  - „Was haben wir heute hauptsächlich geübt?" -> *Finten!*
  - „Auf was kam es bei der Übung mit mir (Trainerstellung) an?" -> *Kopf hochnehmen, schauen, wo der Raum offen ist!*
- **Ausblick:** „Nächstes Mal wird es laut und wir brauchen viel Schusskraft: Unser Thema wird der **Torschuss** sein."
- **Abschlussritual:** Gemeinsamer Ruf / Abklatschen und pünktliches Ende.

## Coachingpunkte ueber die gesamte Einheit

- Ballverluste nach mutigen Finten positiv bestaerken.
- Nach jeder Finte den explosiven ersten Schritt einfordern.
- Wahrnehmung staerken: erst schauen, dann handeln.
- Korrekturen kurz halten, damit Spielzeit hoch bleibt.

Die Einheit verbindet Wahrnehmen, Verstehen und Entscheiden mit viel Spielnaehe.

## Kurzreflexion nach der Einheit

- Was lief gut? (z. B. mutige 1-gegen-1-Aktionen)
- Was wird angepasst? (z. B. Feldgroesse, Regeln, Gruppierung)
- Naechster Schwerpunkt: Torschuss
