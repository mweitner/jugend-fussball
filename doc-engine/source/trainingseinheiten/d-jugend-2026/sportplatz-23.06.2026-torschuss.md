...
- Intensivphasen kurz halten, viele Wiederholungen mit Wartezeit im Schatten.
...
## Option A: Wenn Belastung gut steuerbar ist

- 2 x 10 Minuten Abschlussspiel (kurze Unterbrechung dazwischen).
- Frei spielen lassen, nur positives Coaching auf gute Abschlüsse und Entscheidungen.
- Intensität bei Bedarf sofort runterregeln.

## Option B: Wenn Hitze zu hoch ist (empfohlen bei > 30 Grad)

- Kein langes Abschlussspiel.
- Stattdessen 2 Rotationen à 10 Minuten:
  - Rotation 1: ruhige Abschluss-Challenge (Platzierung statt Härte).
  - Rotation 2: Standards light (Ecke kurz, Freistoß indirekt, schneller Abschluss).
- Fokus auf Technikqualität bei niedrigerer Kreislaufbelastung.

### ⏱️ 4. Abschlussbesprechung (19:25-19:30 | 5 Minuten)

- Kurzer Teamkreis im Schatten.
- Leitfragen:
  - Was hat beim Torschuss heute gut funktioniert?
  - Wann war die Ablage vor dem Abschluss sinnvoll?
  - Wer hat bewusst den Kopf oben behalten und schnell entschieden?
- Ausblick auf nächstes Training und gemeinsamer Abschlussruf.

## Traineraufgaben (Plan mit 3 Trainern)

- Trainer 1: Feld A steuern (Regeln, Spielformen, Belastung).
- Trainer 2: Feld B steuern (Regeln, Spielformen, Belastung).
- Trainer 3 (Josi): Athletikblock, Hitzemonitoring, Technikcoaching in den Übungsformen.

## Materialcheck

- 20 Leibchen in 4 Farben
- 25-30 Bälle
- 20-30 Hütchen
